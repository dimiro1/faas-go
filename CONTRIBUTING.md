...
- AI integration
  - We can proxy the requests to external AI services like OpenAI or others.
  - We have an UI to view all the traces generated by the AI requests.
  - We introduce new lua APIs to interact with AI services.
- Possibilty to manage the functions outside the admin application using a CLI tool or API calls.
- Email APIS
  - We could use a provider such as resend.
