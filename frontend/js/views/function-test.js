                ...
                m(".test-tab-container", [
                    ...
                    m(".test-panels", [
                        ...
                        m(RequestBuilder, {
                            ...
                            query: FunctionTest.testRequest.query,
                            body: FunctionTest.testRequest.body,
                            onMethodChange: (value) => FunctionTest.testRequest.method = value,
                            onQueryChange: (value) => FunctionTest.testRequest.query = value,
                        ...
                        m(Card, { class: "response-viewer" }, [
                            m(CardHeader, {
                                title: "Response",
                                subtitle: FunctionTest.testResponse ? `Status: ${FunctionTest.testResponse.status}` : null
                            }),
                            m(CardContent, [
                                FunctionTest.testResponse
                                    ? m("div", [
                                        m(".response-status", [
                                            m(Badge, {
                                                variant: FunctionTest.testResponse.status === 200 ? BadgeVariant.SUCCESS : BadgeVariant.DESTRUCTIVE,
                                                size: BadgeSize.SM
                                            }, FunctionTest.testResponse.status)
                                        ]),
                                        m(".response-body", [
                                            m("label.form-label", "Body"),
                                            m("pre.response-pre", FunctionTest.testResponse.body)
                                        ]),
                                        FunctionTest.testLogs.length > 0 && m(".response-logs", [
